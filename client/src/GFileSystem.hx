...
//	var mc_cmd				: MCField;
	...
	public var fl_fresh		: Bool; // jamais connect�
...
//		applyNameUnicity();
		...
		// Fichiers sp�ciaux r�serv�s aux niveaux difficiles
...
//			return false;
	...
	function lockFoldersWithPasswords(n:Int) {
		...
		// on �vite de locker tous les dossiers d'un syst�me qui en contient peu (genre Tv)
	...
	public function hidePasswords() {
		...
		for (i in 0...n) {
			...
			// pas r�ussi ? on cr�e un dossier dans root !
	...
	public function uploadFile(?parent:FSNode, key:String) {
		...
		// prend la place d'un fichier effac�
		var rep : FSNode = null;
	...
	public function replaceFile(fname:String,?owner:String,?fl_target=true) { // TODO g�rer unicit� de nom
	...
	public function replaceFileByKey(k:String, fname:String,?owner:String,?fl_target=true) { // TODO g�rer unicit� de nom
