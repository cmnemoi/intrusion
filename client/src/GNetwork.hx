...
//				generate(useful,total,gw);
			...
			try {
				...
				// on d�termine le syst�me prot�g� par les micro-verrous
	...
	function generateStructure() {
		...
		if ( rseed.random(100)<66 )
			...
			genEmpty = rseed.random(8)+4; // r�seau �tendu (lignes longues)
...
//		}
//		else {
//			// normal mode (beaucoup de terminaux � la suite les uns des autres...)
...
//		if ( node.type!=Empty )
	...
	function dispatchMoney(total:Int) {
		// recherche de syst�me contenant des PACKs
		var pool = new Array();
		for (n in nodes)
